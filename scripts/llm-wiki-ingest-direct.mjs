...
const WIKI_STRUCTURE_FILES = [
  ...
  ["main/00-overview.md", "Master Workspace Overview", "Use the four master documents below as the primary LLM-Wiki working surface. Keep this page concise and navigational.", [
    "- [[main/01-projects.md|Projects]]",
    "- [[main/02-problems.md|Problems]]",
    "- [[main/03-mentoring.md|Mentoring]]",
    "- [[main/04-todos-actions.md|Todos and Actions]]",
  ]],
  ["main/01-projects.md", "Projects", "Maintain all current projects, opportunities and initiatives with status, priorities, relationships, risks and source-linked analysis. Update existing entries instead of creating mini-articles."],
  ["main/02-problems.md", "Problems", "Maintain all problems, blockers, recurring tensions, unresolved questions, decision problems, pain points and root-cause analysis. Mark uncertainty and link every central claim to source pages."],
  ["main/03-mentoring.md", "Mentoring", "Maintain the next mentoring onepager, discussion topics, mentor questions, outcomes, durable learnings, follow-ups and a compact mentoring history with source backlinks."],
  ["main/04-todos-actions.md", "Todos and Actions", "Maintain concrete tasks, follow-ups, deadlines, next steps and completed actions. Every item needs a created date, status, context and one or more source links. Mark completed work instead of deleting it."],
  ["system/taxonomy.md", "Taxonomy", "Define the four canonical master documents and the rules for filing durable knowledge into them. Avoid empty topic pages and folder growth."],
  ...
  ["system/ingest-rules.md", "Ingest Rules", "During each Codex organization pass: review new source pages, deeply synthesize relevant knowledge into the four master documents, update existing entries instead of duplicating them, add source backlinks for every central claim, mark uncertainty and priority, preserve completed actions, refresh the source map, and append a concise log entry."],
];
...
function sourcePageContent(context, item, rawAbsolutePath, extract, type) {
  return [
    ...
    "- [[main/00-overview.md|Master Workspace Overview]]",
    "- [[main/01-projects.md|Projects]]",
    "- [[main/02-problems.md|Problems]]",
    "- [[main/03-mentoring.md|Mentoring]]",
    "- [[main/04-todos-actions.md|Todos and Actions]]",
