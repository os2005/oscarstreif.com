...
- Review it as a standalone project website delivered by the platform.
...
4. Does `/shared/[slug]` remain the canonical project delivery route?
...
9. If no module exists, does the platform avoid rendering `ProjectShowcase` and handle the missing module safely?
...
14. Does the page avoid the oscarstreif.com Header, navigation, PageShell, ProjectShowcase and grain overlay?
15. Is the injected project exit button present and working?
16. Do available checks pass?
17. What TODOs remain?
